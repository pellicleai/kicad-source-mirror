...
int BOARD_EDITOR_CONTROL::ToggleAiAssistant( const TOOL_EVENT& aEvent )
{
    getEditFrame<PCB_EDIT_FRAME>()->ToggleAiAssistant();
    return 0;
}
...
void BOARD_EDITOR_CONTROL::setTransitions()
{
    ...
    Go( &BOARD_EDITOR_CONTROL::ToggleAiAssistant,      ACTIONS::showAiAssistant.MakeEvent() );
